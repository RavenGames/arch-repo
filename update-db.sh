...
repo-add online-repo.db.tar.gz *.tar.zst
echo -e "\n${BGreen}[+] Successful Updating ✔"
sleep 0.5

# remove syslink to avoid any issues #
echo -e "${BRed}\n[+] Removing syslink to avoid any Issues...\n${Color_Off}"
rm online-repo.db online-repo.files
mv online-repo.db.tar.gz online-repo.db
mv online-repo.files.tar.gz online-repo.files
echo -e "\n${BGreen}[+] Successful Removing ✔"
sleep 0.5
